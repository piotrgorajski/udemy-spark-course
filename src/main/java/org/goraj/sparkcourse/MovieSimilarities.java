...
public class MovieSimilarities {
    ...
    public static void main(String[] args) throws IOException {
        JavaSparkContext sc = new JavaSparkContext("local[*]", "MovieSimilarities");

        System.out.println("Loading movie names...");
        Map<Integer, String> nameDict = loadMovieNames();

        JavaRDD<String> data = sc.textFile("src/main/resources/u.data");
        ...
        JavaRDD<UserRatingPair> uniqueJoinedRatings = joinedRatings.map(d -> new UserRatingPair(d._1(), d._2()._1(), d._2()._2())).filter(MovieSimilarities::filterDuplicates);

        // Now key by (movie1, movie2) pairs.
        JavaPairRDD<Tuple2<Integer, Integer>, RatingPair> moviePairs = uniqueJoinedRatings.mapToPair(MovieSimilarities::makePairs);
        ...
        JavaPairRDD<Tuple2<Integer, Integer>, Tuple2<Double, Integer>> moviePairSimilarities = moviePairRatings.mapValues(MovieSimilarities::computeCosineSimilarity).cache();
